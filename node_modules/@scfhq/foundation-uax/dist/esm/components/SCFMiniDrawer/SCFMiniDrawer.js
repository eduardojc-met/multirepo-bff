...
export const SCFMiniDrawer = ({ arrayMenu, arrayMenu2, show = true, }) => {
        ...
        React.createElement(Box, { sx: { display: 'flex' } },
            ...
            React.createElement(AppBar, { position: "fixed", open: open },
                React.createElement(Toolbar, null,
                    React.createElement(IconButton, { color: "inherit", "aria-label": "open drawer", onClick: handleDrawerOpen, edge: "start", sx: {
                            marginRight: 5,
                            ...(open && { display: 'none' }),
                        } },
                        React.createElement(MenuIcon, null)),
                    React.createElement(Typography, { variant: "h6", noWrap: true, component: "div" }, "Mini variant drawer"))),
            React.createElement(Drawer, { variant: "permanent", open: open },
                ...
                React.createElement(List, null, arrayMenu.map((text, index) => (React.createElement(ListItemButton, { key: text, sx: {
                        minHeight: 48,
                    ...
                    React.createElement(ListItemIcon, { sx: {
                        ...
                        } }, index % 2 === 0 ? React.createElement(InboxIcon, null) : React.createElement(MailIcon, null)),
                    React.createElement(ListItemText, { primary: text, sx: { opacity: open ? 1 : 0 } }))))),
                React.createElement(Divider, null),
                arrayMenu2 && (React.createElement(List, null, arrayMenu2.map((text, index) => (React.createElement(ListItemButton, { key: text, sx: {
                        minHeight: 48,
                        justifyContent: open ? 'initial' : 'center',
                        px: 2.5,
                    } },
